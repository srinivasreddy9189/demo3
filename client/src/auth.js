...
const renderUserName = ()=>{
    return(
        ...
        <input type='text' id='name' className='form-control input1' value={name} placeholder='Enter your name' onChange={((e)=>setName(e.target.value))}/>
...
const renderEmail = ()=>{
    return(
        ...
        <input type='text' id='email' className='form-control input1' value={email} placeholder='Enter your email' onChange={((e)=>setEmail(e.target.value))}/>
...
const renderPhone = ()=>{
    return(
        ...
        <input type='text' id='phone' className='form-control input1' value={phoneNumber} placeholder='Enter your number' onChange={((e)=>setPhoneNumber(e.target.value))}/>
...
const renderGender = ()=>{
    return(
        ...
        <input type='text' id='gender' className='form-control input1' value={gender} placeholder='Enter your gender' onChange={((e)=>setGender(e.target.value))}/>
...
const renderPassword = ()=>{
    return(
        ...
        <div className='form-control input1'>
        ...
        <button className='button3' onClick={(()=>setShow(!show))}>{show?<FaRegEye/>:<FaRegEyeSlash/>}</button>
        </div>
        </>
    );
}
...
if(loginBtn === 'login'){
    const url1 = "http://localhost:4002/auth/login"
   ...
   useEffect(()=>{
    ...
    return(
        <div className='cont1'>
            ...
            <div className='card1 '>
                <div className='img_cont1'><img src='https://assets.ccbp.in/frontend/react-js/logo-img.png ' className='img1 mt-4'/></div>
